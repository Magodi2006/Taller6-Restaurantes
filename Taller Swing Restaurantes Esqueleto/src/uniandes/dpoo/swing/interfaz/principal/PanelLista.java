...
public class PanelLista extends JPanel implements ListSelectionListener
{
    ...
    /**
    * Reemplaza completamente la lista de restaurantes en pantalla.
    */
    public void actualizarLista(List<Restaurante> restaurantes) {
        dataModel.clear();  // Limpia todo el modelo anterior
        for (Restaurante r : restaurantes) {
            dataModel.addElement(r);  // Agrega cada restaurante nuevo
        }
    }
