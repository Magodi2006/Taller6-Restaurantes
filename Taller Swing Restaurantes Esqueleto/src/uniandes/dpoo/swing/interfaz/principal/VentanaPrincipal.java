...
public class VentanaPrincipal extends JFrame
{
    ...
    {
        System.out.println("Clic detectado: abriendo ventana de nuevo restaurante");
    ...
    public void agregarRestaurante( String nombre, int calificacion, int x, int y, boolean visitado )
    {
        ...
        actualizarRestaurantes(); // refrescar lista y detalles
    }
    ...
    private void actualizarRestaurantes( )
    {
        ...
        if (!todos.isEmpty()) {
            cambiarRestauranteSeleccionado(todos.get(0)); // mostrar el primero
}
